...
## Capítulo 1 – Desvendando o micro:bit apresenta as características da micro:bit e do ambiente de programação Makecode, bem como o processo de conexão e transferência da programação entre o Makecode e a micro:bit.
...
## Capítulo 14 – magic:bit – Jogo da adivinhação. Vamos construir um pequeno jogo para que você tenha uma ideia de como algoritmos diferentes para o mesmo problema podem ter desempenhos completamente diferentes. Não é mágica, é matemática!
